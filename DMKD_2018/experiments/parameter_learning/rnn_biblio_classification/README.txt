To run the parameter learning classification experiment on the AMiner data set,
...
The best results on validation set sets the l-cla assignment.

To run a single experiment, run run_classification_local.sh, and insert the
...
* The TET used in this experiment is in the tet-apc file. It is the
