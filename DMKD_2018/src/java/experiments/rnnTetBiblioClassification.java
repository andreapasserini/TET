...
public class rnnTetBiblioClassification extends rnnTetLocalStore{
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            TetParameterLearner learner = new TetParameterLearner(tet, dataset, new CrossEntropy(), adam, out);

            /* LEarn the parameters of the regression task */
            learner.learnParameters(options.iterations_limit, 10,"classification");
