...
public class Tet{
    ...
    protected Type root;
    protected TreeSet<Variable> freevars; /* contains the free variables of this Tet */
    protected Vector<TetChild> children;
    ...
    */
    ...
    public void parseVerboseTet(StringTokenizer tokenizer) throws Exception{
        ...
        if(!tokenizer.nextToken().trim().equals("NODE") ||
            !tokenizer.nextToken().trim().equals("{") ||
            !tokenizer.nextToken().trim().equals("TYPE"))
            throw new Exception("Malformed TET string");
        ...
        while(!(tokenizer.nextToken().equals("}"))){ // end of both recursion and children list
            if(!tokenizer.nextToken().trim().equals("CHILD") ||
                !tokenizer.nextToken().trim().equals("("))
                throw new Exception("Malformed TET string");
